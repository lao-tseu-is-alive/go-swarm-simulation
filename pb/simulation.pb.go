...
type UpdateConfig struct {
	...
	DisplaySpatialGrid     bool `protobuf:"varint,17,opt,name=display_spatial_grid,json=displaySpatialGrid,proto3" json:"display_spatial_grid,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *UpdateConfig) GetDisplaySpatialGrid() bool {
	if x != nil {
		return x.DisplaySpatialGrid
	}
	return false
}
...
const file_pb_simulation_proto_rawDesc = "" +
	...
	"isGameOver\x12\x16\n" +
	"\x06winner\x18\x05 \x01(\tR\x06winner\"\xbb\x05\n" +
	"\fUpdateConfig\x12)\n" +
	...
	"\x16display_defense_circle\x18\x10 \x01(\bR\x14displayDefenseCircle\x120\n" +
	"\x14display_spatial_grid\x18\x11 \x01(\bR\x12displaySpatialGrid*>\n" +
	"\tTeamColor\x12\x14\n" +
